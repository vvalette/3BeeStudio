...
- **Fiche admin, deux cartes qui ne se marchent plus dessus** : « Devis » porte le document et ses montants (total, acompte, objet, numéro) avec deux gestes, **Envoyer au client** ou **Enregistrer sans envoyer** (devis déjà transmis de son côté, acompte déjà encaissé) ; « Paiements » porte l'argent, réclamation du solde comprise
